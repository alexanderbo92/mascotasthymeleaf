...
public class CienCuadras extends PlataformaInmobiliaria {
	...
	public String consultar() {
		...
		headers.add("Authorization", "Basic MXRjbW03MzQyajY2NjFvNDRnZ2JvNGoxNnA6MTlnYW1hOXJxaXRodHE4OWZkN3NoYzl2Y2xtdXVtbWFoYmJnOTc1ZjJpNzB0dDFrc21saA==");
		...
		ResponseEntity<RespuestaToken> respuesta = restTemplate.postForEntity(
				"https://ciencuadras-prod-api-auth.auth.us-east-1.amazoncognito.com/oauth2/token"
				,entity, RespuestaToken.class);
		...
		HttpEntity<String> request2 = new HttpEntity<>(
